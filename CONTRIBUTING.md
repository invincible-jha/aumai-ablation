# Contributing to AumAI Ablation
...
### Setup
```bash
git clone https://github.com/aumai/aumai-ablation.git
cd aumai-ablation
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-ablation/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-ablation/discussions)
